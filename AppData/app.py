...
tpot_data = pd.read_csv('https://raw.githubusercontent.com/karthikreddykuna/ModelSaving_Test_11/master/AppData/prepared_data.csv')
...
title = 'App'
encoder_location = ''
target_encoder_location = 'https://github.com/karthikreddykuna/ModelSaving_Test_11/blob/master/AppData/target_encoder.pkl?raw=true'
